...
// Fetch site config and shipping policy sections
try {
    $db = getDbConnection();
...
<main class="container my-5">
    ...
    <div class="text-center mb-5">
        ...
        <p class="lead text-muted">Our Guidelines for Delivering Aid and Resources</p>
        ...
        <div class="card-body p-0">
            ...
            <?php else: ?>
                <div class="p-5 text-center">
                    ...
                    <p class="text-muted">Shipping policy content is being updated. Please check back soon.</p>
                </div>
            <?php endif; ?>
            ...
            <div class="p-4 p-md-5 text-white" style="background: var(--gradient-primary);">
                <div class="text-center mb-4">
                    ...
                    <p class="opacity-75">For questions, concerns, or issues regarding our shipping process, please contact us:</p>
                </div>
