...
// Fetch site config and refund policy sections
try {
    $db = getDbConnection();
    ...
    // Get active refund policy sections
    $stmt = $db->prepare("SELECT * FROM refund_policy_content WHERE status = 'active' ORDER BY sort_order ASC");
    $stmt->execute();
    $sections = $stmt->fetchAll(PDO::FETCH_ASSOC);
} catch (PDOException $e) {
    logError("Error fetching refund policy content: " . $e->getMessage());
    $sections = [];
    $site = null;
}
?>
...
<main class="container my-5">
    ...
    <div class="text-center mb-5">
        ...
        <p class="lead text-muted">Understand Our Donation and Refund Guidelines</p>
    ...
    <div class="card border-0 shadow-lg" style="border-radius: 15px; overflow: hidden;">
        ...
        <div class="card-header py-4 text-center text-white" style="background: var(--gradient-primary);">
            ...
            <p class="mb-0 opacity-75">Non-Profit Organization | <?php echo htmlspecialchars($site['email'] ?? 'contact@foundation.org'); ?></p>
        </div>
        ...
        <div class="card-body p-0">
            ...
            <?php else: ?>
                <div class="p-5 text-center">
                    ...
                    <p class="text-muted">Refund policy content is being updated. Please check back soon.</p>
                </div>
            <?php endif; ?>
            ...
            <div class="p-4 p-md-5 text-white" style="background: var(--gradient-primary);">
                <div class="text-center mb-4">
                    ...
                    <p class="opacity-75">For inquiries about transactions, refunds, or suspected errors, please contact us:</p>
                </div>
