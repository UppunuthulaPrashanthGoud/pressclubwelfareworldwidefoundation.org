...
// Fetch site config and terms and conditions sections
try {
    $db = getDbConnection();
    ...
    // Get active terms and conditions sections
    $stmt = $db->prepare("SELECT * FROM terms_conditions_content WHERE status = 'active' ORDER BY sort_order ASC");
    $stmt->execute();
    $sections = $stmt->fetchAll(PDO::FETCH_ASSOC);
} catch (PDOException $e) {
    logError("Error fetching terms and conditions content: " . $e->getMessage());
    $sections = [];
    $site = null;
}
?>
...
<main class="container my-5">
    ...
    <div class="text-center mb-5">
        <div class="d-inline-block p-3 rounded-circle mb-3" style="background: var(--gradient-primary);">
            <i class="fas fa-file-contract fa-3x text-white"></i>
        </div>
        <h3 class="section-heading text-center mb-4">
            <span>Terms and Conditions</span>
        </h3>
        <p class="lead text-muted">Guidelines for Using Our Services</p>
    ...
    <div class="card border-0 shadow-lg" style="border-radius: 15px; overflow: hidden;">
        ...
        <div class="card-header py-4 text-center text-white" style="background: var(--gradient-primary);">
            ...
            <p class="mb-0 opacity-75"><?php echo htmlspecialchars($site['site_subtitle'] ?? 'Non-Profit Organization'); ?> | <?php echo htmlspecialchars($site['email'] ?? 'contact@foundation.org'); ?></p>
        </div>
        ...
        <div class="card-body p-0">
                        ...
                        <div class="row align-items-start">
                            <div class="col-lg-2 col-md-3 text-center mb-4 mb-md-0">
                                <div class="rounded-circle d-inline-flex align-items-center justify-content-center" 
                                     style="width: 80px; height: 80px; background: rgba(255, 111, 15, 0.1);">
            ...
            <div class="p-4 p-md-5 text-white" style="background: var(--gradient-primary);">
                <div class="text-center mb-4">
                    ...
                    <p class="opacity-75">For questions, complaints, or requests regarding these Terms and Conditions, please contact us below:</p>
                </div>
