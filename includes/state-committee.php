...
");
$stmt->execute();
$state_members = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
// Get unique districts from state members
$districts = array_unique(array_filter(array_column($state_members, 'district')));
sort($districts);
?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const stateFilter = document.getElementById('state-state-filter');
    const districtFilter = document.getElementById('state-district-filter');
    const memberItems = document.querySelectorAll('.state-item');
    const noResultsDiv = document.getElementById('state-no-results');
