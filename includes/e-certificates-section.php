...
<?php if (!empty($homepageECertificates)): ?>
    <div class="container-fluid my-5 e-certificate-section" id="e-certificates-section">
        <div class="container">
            <div
                class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4 e-certificate-section-header">
            ...
            <div id="eCertificateCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="4500">
                                            ...
                                            <div class="card-custom e-certificate-card h-100">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-start gap-2 mb-2">
                                                        <span
                                                            class="badge <?php echo eCertificateIsPdf($certificate) ? 'bg-danger' : 'bg-success'; ?>">
                ...
                <?php if (count($certificateChunks) > 1): ?>
                    <button class="carousel-control-prev" type="button" data-bs-target="#eCertificateCarousel"
                        data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#eCertificateCarousel"
                        data-bs-slide="next">
                    ...
                    <div class="carousel-indicators">
                        <?php foreach ($certificateChunks as $index => $unusedChunk): ?>
                            <button type="button" data-bs-target="#eCertificateCarousel" data-bs-slide-to="<?php echo $index; ?>"
