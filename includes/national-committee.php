...
");
$stmt->execute();
$national_members = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
// Get unique districts from national members
$districts = array_unique(array_filter(array_column($national_members, 'district')));
sort($districts);
?>
...
document.addEventListener('DOMContentLoaded', function() {
    const searchInput = document.getElementById('national-search');
    const stateFilter = document.getElementById('national-state-filter');
    const districtFilter = document.getElementById('national-district-filter');
    const memberItems = document.querySelectorAll('.national-item');
    const noResultsDiv = document.getElementById('national-no-results');
