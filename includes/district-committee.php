<?php
// Fetch District Committee Members (District, Block, Tehsil, Mandal levels)
$stmt = $db->prepare("
...
");
$stmt->execute();
$district_members = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
// Get unique districts from district members
$districts = array_unique(array_filter(array_column($district_members, 'district')));
sort($districts);
...
<section class="committee-section py-5">
    <div class="container">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3 mb-3">
                <select id="district-level-filter" class="form-select">
            ...
            <div class="col-md-3 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" id="district-search" class="form-control" placeholder="Search by name...">
                </div>
            </div>
        </div>
            ...
            <?php else: ?>
                <?php foreach ($district_members as $member): ?>
                    <div class="col-xl-3 col-lg-4 col-md-6 district-item" 
                         ...
                         data-level="<?php echo strtolower(htmlspecialchars($member['membership_type'])); ?>">
                        <div class="supporter-card">
                            ...
                            <div class="supporter-body">
                                ...
                                <div class="supporter-details text-center">
                                    ...
                                    <p class="mb-1 small">
                                        <span class="badge bg-primary"><?php echo $membership_labels[$member['membership_type']]; ?></span>
                                    </p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const stateFilter = document.getElementById('district-state-filter');
    const districtFilter = document.getElementById('district-district-filter');
    const levelFilter = document.getElementById('district-level-filter');
    const memberItems = document.querySelectorAll('.district-item');
    const noResultsDiv = document.getElementById('district-no-results');
    ...
    function filterMembers() {
        ...
        memberItems.forEach(item => {
            ...
            if (matchesSearch && matchesState && matchesDistrict && matchesLevel) {
