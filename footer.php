                ...
                <div class="col-xl-2 col-lg-2 col-md-6 col-6 mb-4">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="donation-form.php"><i class="fas fa-chevron-right"></i> Donations</a></li>
                ...
                <div class="col-xl-6 col-lg-6 text-center text-lg-start">
                    <div class="copyright-text">
                        <p>Copyright &copy; <?php echo date('Y'); ?>, All Rights Reserved 
                            <a href="index.php">Welcome To Press Club Welfare Worldwide Foundation
Approved By Ministry Of Corporate Affairs, Government of India</a>
                        </p>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 text-center text-lg-end">
                    <div class="footer-menu">
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item"><a href="shipping-policy.php">Shipping Policy</a></li>
                        </ul>
                    </div>
                </div>
            </div>
