...
// Fetch site config and disclaimer sections
try {
    $db = getDbConnection();
    ...
    // Get active disclaimer sections
    $stmt = $db->prepare("SELECT * FROM disclaimer_content WHERE status = 'active' ORDER BY sort_order ASC");
    $stmt->execute();
    $sections = $stmt->fetchAll(PDO::FETCH_ASSOC);
} catch (PDOException $e) {
    logError("Error fetching disclaimer content: " . $e->getMessage());
    $sections = [];
    $site = null;
}
?>
...
<main class="container my-5">
    ...
    <div class="text-center mb-5">
        ...
        <p class="lead text-muted">Important Information About Our Services and Website Usage</p>
        ...
        <div class="card-body p-0">
            ...
            <?php else: ?>
                <div class="p-5 text-center">
                    ...
                    <p class="text-muted">Disclaimer content is being updated. Please check back soon.</p>
                </div>
            <?php endif; ?>
            ...
            <div class="p-4 p-md-5 text-white" style="background: var(--gradient-primary);">
                <div class="text-center mb-4">
                    ...
                    <p class="opacity-75">For any questions or concerns regarding this disclaimer, please contact us:</p>
                </div>
