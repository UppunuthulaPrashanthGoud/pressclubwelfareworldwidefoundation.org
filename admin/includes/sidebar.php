        ...
        <div class="menu-item has-dropdown">
            ...
            <div class="dropdown-menu" id="contentMenu">
                ...
                <a href="<?php echo SITE_URL; ?>/admin/e_certificates.php" class="dropdown-item <?php echo basename($_SERVER['PHP_SELF']) == 'e_certificates.php' ? 'active' : ''; ?>">
                  ...
                  <a href="<?php echo SITE_URL; ?>/admin/congratulations_certificates.php" class="dropdown-item <?php echo basename($_SERVER['PHP_SELF']) == 'congratulations_certificates.php' ? 'active' : ''; ?>">
                    <i class="fas fa-certificate"></i>
