<?php
/**
 * Enhanced Universal ID Card Generator for Women’s Protection and Empowerment Worldwide Foundation
 ...
 * Updated to dynamically use config constants for organization details
 */
...
class UniversalIdCardGenerator {
    ...
    public function __construct($database = null) {
        ...
        $this->config = [
            ...
            'organization_name' => defined('ORGANIZATION_NAME_HINDI') ? ORGANIZATION_NAME_HINDI : (defined('ORGANIZATION_NAME') ? ORGANIZATION_NAME : 'Women’s Protection and Empowerment Worldwide Foundation'),
            'organization_name_en' => defined('ORGANIZATION_NAME') ? ORGANIZATION_NAME : 'Women’s Protection and Empowerment Worldwide Foundation',
            'registration_info' => defined('REGISTRATION_INFO') ? REGISTRATION_INFO : 'Reg No :- U88900WB2025NPL277730',
            'email' => defined('ORGANIZATION_EMAIL') ? ORGANIZATION_EMAIL : 'womensprotectionfoundation@gmail.com',
            'canvas_width' => 1011,
            'canvas_height' => 1378,
            'front_start_y' => 172.4,
            'front_end_y' => 607.3,
            ...
            'helpline_no' => defined('HELPLINE_NO') ? HELPLINE_NO : '9040898333',
            'website_qr' => SITE_URL,
    ...
    public function generateScannableData($memberData, $format = 'text') {
        ...
        $data = [
            ...
            'organization' => $this->config['organization_name_en'],
        ...
        const UniversalIdCardGenerator = {
            ...
            generateScannableData: function(memberData, format = 'text') {
                ...
                const data = {
                    ...
                    address: memberData.address || '',
                    working_area: memberData.working_area || '',
                    organization: this.config.organization_name_en || 'Women’s Protection and Empowerment Worldwide Foundation',
                    website: this.config.website_qr || '',
                    helpline: this.config.helpline_no || '9040898333',
            ...
            drawBackDetails: function(startY, height) {
                ...
                const disclaimer = 'This identity card is the property of ' + this.config.organization_name_en + '. For any queries contact: ' + this.config.helpline_no + '. It should be used only subject to the rules/terms of the organization. Action may be taken against the cardholder for misuse. In case of loss, contact the organization immediately.';
