        ...
        switch ($_POST['action']) {
            ...
            case 'delete':
                try {
                    ...
                    if (!empty($news['image']) && file_exists('Uploads/news/' . $news['image'])) {
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <div class="page-actions">
                ...
                <a href="?action=add" class="btn btn-primary">
                    <i class="fas fa-plus me-2"></i> नया समाचार जोड़ें
                </a>
                <?php else: ?>
        ...
        <div class="admin-card">
            <div class="card-header">
                <h5><i class="fas fa-list me-2"></i> समाचार सूची</h5>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <img src="<?php echo SITE_URL . '/Uploads/news/' . $news['image']; ?>" 
                                ...
                                <td>
                                    <span class="badge bg-<?php echo $news['status'] === 'active' ? 'success' : ($news['status'] === 'draft' ? 'warning' : 'secondary'); ?>">
                                        <?php echo htmlspecialchars($news['status'] === 'active' ? 'सक्रिय' : ($news['status'] === 'draft' ? 'ड्राफ्ट' : 'निष्क्रिय')); ?>
                                    </span>
                                </td>
                                <td><?php echo htmlspecialchars($news['author'] ?? 'अज्ञात'); ?></td>
                                <td>
                                    <?php echo date('d M Y', strtotime($news['created_at'])); ?>
                                </td>
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="?action=edit&id=<?php echo $news['id']; ?>" class="btn btn-sm btn-outline-primary" title="संपादित करें">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <button type="button" class="btn btn-sm btn-outline-danger" onclick="deleteNews(<?php echo $news['id']; ?>)" title="हटाएं">
            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-2">
                            <img src="<?php echo SITE_URL . '/Uploads/news/' . $news_data['image']; ?>" 
